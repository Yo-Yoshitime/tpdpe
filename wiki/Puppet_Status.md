...
<p>Some types, such as <a href="/Fire" title="Fire">Fire</a> and <a href="/Poison" title="Poison">Poison</a> have innate status immunity under normal conditions (listed on the <a href="/Type-Chart" title="Type Chart">Type Chart</a> page), <a href="/Resonance" title="Resonance">Resonance</a> bypasses this immunity if a status is passed on to the aforementioned types. Further immunities are listed under the respective status condition.</p>
